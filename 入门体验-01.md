...
参考: `https://github.com/yjaal/rocketmq.git`的4.5.1分支中的案例
...
参考：`https://github.com/yjaal/rocketmq-externals.git`

在master分支上面的rocketmq-springboot工程



### 4.8 springCloudStream整合

这个框架对于kafka、rabbitMQ整合比较好，而对于rocketMQ的整合由阿里自己管理，支持不是那么好。
